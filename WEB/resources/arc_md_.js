...
function DefineInterface_arc_md_(id,mystore){
...
var grid_arc_chanel;
    ...
    if( grid_arc_chanel.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('arc.edit')!=0){
                var edit = Ext.create('EditWindow_arc_chanel');
...
var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('arc.edit')!=0){
                var edit = Ext.create('EditWindow_arc_md');
...
function DefineForms_arc_md_(){


Ext.define('Form_arc_md', {
extend:  'Ext.form.Panel',
alias: 'widget.f_arc_md',
...
Ext.define('Form_arc_chanel', {
extend:  'Ext.form.Panel',
alias: 'widget.f_arc_chanel',
initComponent: function(){
    //this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_arc_chanel', {
    extend:  'Ext.window.Window',
    maxHeight: 705,
    maxWidth: 900,
    autoScroll:true,
