...
function DefineInterface_arc_md_main(id,mystore){
...
var grid_arc_chanel;
    ...
    if( grid_arc_chanel.parentid=='{00000000-0000-0000-0000-000000000000}') {return;}
   	if(CheckOperation('arc.edit')!=0){
                var edit = Ext.create('EditWindow_arc_chanelmain');
...
var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('arc.edit')!=0){
                var edit = Ext.create('EditWindow_arc_mdmain');
...
function DefineForms_arc_md_main(){


Ext.define('Form_arc_mdmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_arc_mdmain',
...
Ext.define('EditWindow_arc_mdmain', {
...
Ext.define('Form_arc_chanelmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_arc_chanelmain',
initComponent: function(){
    //this.addEvents('create');
    Ext.apply(this,{
        activeRecord: null,
...
Ext.define('EditWindow_arc_chanelmain', {
    extend:  'Ext.window.Window',
    maxHeight: 515,
    maxWidth: 900,
    autoScroll:true,
