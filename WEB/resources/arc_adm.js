...
'Ext.form.*'
  ...
  arc_adm= null;
function arc_Panel_adm(objectID, RootPanel, selection){ 
    ...
    var store_arc_chanel = Ext.create('Ext.data.Store', {
        ...
        proxy: {
          ...
          DefineForms_arc_info_adm();
          DefineForms_arc_md_adm();
     var   int_arc_info_adm     =      DefineInterface_arc_info_adm('int_arc_info',store_arc_info, selection);
     var   int_arc_md_adm     =      DefineInterface_arc_md_adm('int_arc_md',store_arc_md);
     arc_adm= Ext.create('Ext.form.Panel', {
      ...
      fieldDefaults: {
        ...
        instanceid:objectID,
        		...
        		{
        			var me = this;
        	    int_arc_info_adm.doSave( me.onCommit);
        		},
        		onButtonCancel: function()
        		{
        		},
        canClose: function(){
        	return int_arc_info_adm.canClose();
        },
        items: [{
            xtype:'tabpanel',
            itemId:'tabs_arc',
...
int_arc_md_adm
    ...
    if(RootPanel==true){
       arc_adm.closable= true;
       arc_adm.title= 'Клиент';
       arc_adm.frame= true;
    }else{
       arc_adm.closable= false;
       arc_adm.title= '';
       arc_adm.frame= false;
    }
   ...
   int_arc_info_adm.setActiveRecord(record,objectID);	
   });
       store_arc_info.load( {params:{ instanceid:objectID} }  );
   int_arc_md_adm.instanceid=objectID;	
