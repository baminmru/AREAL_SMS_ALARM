...
function DefineInterface_arsms_data_(id,mystore){
...
showGroupsText:  'Показать группировку'
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('arsms.edit')!=0){
                var edit = Ext.create('EditWindow_arsms_data');
...
function DefineForms_arsms_data_(){


Ext.define('Form_arsms_data', {
extend:  'Ext.form.Panel',
alias: 'widget.f_arsms_data',
