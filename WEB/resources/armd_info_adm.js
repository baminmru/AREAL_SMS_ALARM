...
function DefineInterface_armd_info_adm(id,mystore){
...
showGroupsText:  'Показать группировку'
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('armd.edit')!=0){
                var edit = Ext.create('EditWindow_armd_infoadm');
...
function DefineForms_armd_info_adm(){


Ext.define('Form_armd_infoadm', {
extend:  'Ext.form.Panel',
alias: 'widget.f_armd_infoadm',
...
Ext.define('EditWindow_armd_infoadm', {
