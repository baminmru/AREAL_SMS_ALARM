...
function DefineInterface_armd_type_(id,mystore){
...
showGroupsText:  'Показать группировку'
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('armd.edit')!=0){
                var edit = Ext.create('EditWindow_armd_type');
...
function DefineForms_armd_type_(){


Ext.define('Form_armd_type', {
extend:  'Ext.form.Panel',
alias: 'widget.f_armd_type',
...
Ext.define('EditWindow_armd_type', {
