...
function DefineInterface_armd_type_adm(id,mystore){
...
showGroupsText:  'Показать группировку'
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('armd.edit')!=0){
                var edit = Ext.create('EditWindow_armd_typeadm');
 ...
 p1=   new Ext.grid.Panel(
      ...
      stateful:stateFulSystem,
       stateId:  'armd_typeadm',
        ...
        columns: [
{text: "Название  типа", width: 200, dataIndex: 'name', sortable: true}
        ]
       ,
    listeners: {
...
function DefineForms_armd_type_adm(){


Ext.define('Form_armd_typeadm', {
extend:  'Ext.form.Panel',
alias: 'widget.f_armd_typeadm',
...
Ext.define('EditWindow_armd_typeadm', {
