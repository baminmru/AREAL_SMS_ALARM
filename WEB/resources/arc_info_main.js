...
function DefineInterface_arc_info_main(id,mystore,selection){
            ...
            Ext.Ajax.request({
	            ...
	            if(res.success==false){
                   ...
                   if(selection){
				    ...
				    if (typeof(callaftersave) == 'function') callaftersave();
                    if (close_after_save) {   p1.up('window').close(); }
                }
              }
            });
        }else{
...
function DefineForms_arc_info_main(){


Ext.define('Form_arc_infomain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_arc_infomain',
...
Ext.define('EditWindow_arc_infomain', {
