...
class  M_v_autoarsms_data extends CI_Model {
    ...
    try{
	 ...
	 if (isset($offset) && isset($limit)) {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoarsms_data','FieldList'=>'instanceid,id,arsms_data_opercode,DATE_FORMAT(arsms_data_smstime,\'%Y-%m-%d %H:%i:%s\') arsms_data_smstime,arsms_data_serialno,arsms_data_roof_open,arsms_data_pop_ok,arsms_data_temperature,arsms_data_power_ok','Sort'=>$sort, 'WhereClause' => $whereclause,'Limit'=>$limit,'Offset'=>$offset));
	} else {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoarsms_data','FieldList'=>'instanceid,id,arsms_data_opercode,DATE_FORMAT(arsms_data_smstime,\'%Y-%m-%d %H:%i:%s\') arsms_data_smstime,arsms_data_serialno,arsms_data_roof_open,arsms_data_pop_ok,arsms_data_temperature,arsms_data_power_ok','Sort'=>$sort, 'WhereClause' => $whereclause));
	}
	$root = new stdClass();
	$root->total = $this->jservice->get(array('Action' => 'CountView', 'ViewName' => 'v_autoarsms_data','FieldList'=>'instanceid,id,arsms_data_opercode,DATE_FORMAT(arsms_data_smstime,\'%Y-%m-%d %H:%i:%s\') arsms_data_smstime,arsms_data_serialno,arsms_data_roof_open,arsms_data_pop_ok,arsms_data_temperature,arsms_data_power_ok', 'WhereClause' => $whereclause));
	$root->success = true;
	$root->rows = $res;
	return $root;
}
