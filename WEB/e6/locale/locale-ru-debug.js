...
Ext.define("Ext.locale.ru.form.field.Number", {
    ...
    minText: "Значение э?того поля не может быть меньше {0}",
    maxText: "Значение э?того поля не может быть больше {0}",
...
Ext.define("Ext.locale.ru.form.field.HtmlEditor", {
    ...
    Ext.apply(Ext.form.field.HtmlEditor.prototype, {
        buttonTips: {
            ...
            justifyleft: {
                title: 'Выровня?ть текст по левому краю',
            ...
            justifyright: {
                title: 'Выровняь текст по правому краю',
...
Ext.define("Ext.locale.ru.grid.header.Container", {
    ...
    unlockText: "Сня?ть закрепление столбца",
    columnsText: "Столбцы"
});
